...
echo "rss.host=$RSS_HOST" >> "$WHISK_HOME/whisk.properties"
echo "rss.host.port=11003" >> "$WHISK_HOME/whisk.properties"
echo "rss.docker.port=8080" >> "$WHISK_HOME/whisk.properties"
